...
import { LayoutDashboard, CalendarDays, BedDouble, Users, FileText, Palmtree, LogOut } from 'lucide-react';
...
const AdminSidebar = () => {
    ...
    return (
        <div className="w-64 bg-white h-screen fixed right-0 top-0 border-l border-slate-200 shadow-xl flex flex-col z-50">
